...
class VTK_SLICER_SEGMENTATIONS_LOGIC_EXPORT vtkImageCleverSegSegment : public vtkImageAlgorithm
{
public:
  static vtkImageCleverSegSegment* New();
  vtkTypeMacro(vtkImageCleverSegSegment, vtkImageAlgorithm);
...
protected:
  vtkImageCleverSegSegment();
  ~vtkImageCleverSegSegment() override;
